					...
					If ($checkboxBlockCred.Checked -eq $true)
					{
						...
						Else
						{
							...
							If ($comboboxO365Licenses.SelectedItem -ne $Null)
							{
								...
								Add-Logs -text 'LOG: Pausing for 120 seconds for mailbox to be created (required)'
								Start-Sleep -Seconds 30
								Add-Logs -text 'LOG: 90 seconds reamining'
								...
								If ($textboxO365EmailAddress.Text -ne $null)
								{
									...
									add-logs -text "CMD: Set-Mailbox -Identity ($Mailbox).DisplayName -PrimarySmtpAddress $PrimEmail"
									Set-Mailbox -Identity ($Mailbox).DisplayName -PrimarySmtpAddress $PrimEmail
									add-logs -text "LOG: Done"
									
								}
								Else
								{
									add-logs -text "LOG: No Primary E-Mail entered"
								}
...
')
	...
	$labelAliasEMailAddresses.Location = '19, 341'
	...
	#
	$textboxo365proxyaddresses.Location = '340, 338'
	...
	$textboxo365proxyaddresses.Size = '560, 121'
	$textboxo365proxyaddresses.TabIndex = 4
	#
	# textboxO365EmailAddress
	#
	$textboxO365EmailAddress.Location = '340, 264'
	...
	$labelEMailOnlyIfYouWantIt.Location = '13, 267'
