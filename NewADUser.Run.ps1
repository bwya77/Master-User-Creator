...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       7/3/2018 11:46 AM
     Generated by:       brw18
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
If no license is selected for your user, this will remain disabled"
	...
	$Form_Cleanup_FormClosed=
	{
		...
		try
		{
			...
			$testToolStripMenuItem.remove_Click($testToolStripMenuItem_Click)
...
')
	...
	[void]$fileToolStripMenuItem.DropDownItems.Add($testToolStripMenuItem)
	...
	$testToolStripMenuItem.Size = '405, 38'
...
#region Source: Globals.ps1
	...
	$Sku = @{
		...
		"ENTERPRISEPACKS"					 = "Enterprise Plan E3"
